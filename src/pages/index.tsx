...
const Home: NextPage = () => {
  ...
  return (
    <div>
      ...
      <Flex h="33vh" direction="column" alignItems="center" justifyContent="space-around">
        <Text fontSize="1.5em">Search in Google Play Store and Galaxy Store</Text>
        <Input maxW="400px" ref={inputSearchRef} />
        <Button onClick={handleSearch}>Search</Button>
      </Flex>

      {errorData && <Box textAlign="center" textColor="red">An API error has occurred</Box>}
